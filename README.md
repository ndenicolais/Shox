...
App release 3.0.1 is now available for download. You can download it from the following link:

[Download v3.0.1](https://github.com/ndenicolais/Shox/releases/download/v3.0.1/Shox_v3.0.1.apk)
